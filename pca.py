...
sizes = [1]*(numgood+numbad) + [10]*numquery
...
#plt.scatter(projected[:, 0], projected[:, 1], c=([1]*numgood + [2]*numbad), cmap=plt.cm.get_cmap('tab20b'))
plt.scatter(subset[:, 0], subset[:, 1], c=clist, cmap=cmap, s=sizes)
plt.show()
